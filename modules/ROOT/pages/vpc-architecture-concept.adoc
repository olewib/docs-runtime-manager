...
> You might have to add .<region-code> before cloudhub.io, for example ".de-c1.cloudhub.io" for EU Frankfurt region.
...
> Remember to listen to the 8091/8092 ports explicity in your app if you want to utilize these ports.

The graphic below shows a default Anypoint VPC architecture:

> The graphic doesn't show the ports 8091 / 8092 used internally in shared loadbalancer.
